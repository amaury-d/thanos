...
- [#7585](https://github.com/thanos-io/thanos/pull/7585) fix(sidecar): Allow sidecar to not crash on startup if objstore is not available by adding option "--shipper.retry-init" to sidecar
